...
if(location.href == 'http://localhost:3031/' && localStorage.getItem('darkMode') == null){
    localStorage.setItem('darkMode', false);
}

if(location.href == 'http://localhost:3031/login' || location.href == 'http://localhost:3031/register'){
